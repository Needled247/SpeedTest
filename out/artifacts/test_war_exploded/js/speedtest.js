  ...
  // Constructor
    function SpeedTest(settings, startNow) {
      // Properties
        ...
        this.maxTime = 0; // Maximum time used for one test (download OR upload)
        this.serverFile = 'ServerTool'; // jsp file that will be used to download and upload binary data
      // Events
        this.download = {
          onprogress: function(){},
          onload: function(){}
